...
$duplicate=mysqli_query($conn," SELECT * FROM th_user WHERE Usrname = '$username' OR Email= '$email'");
...
if($password==$confirm)
{
$query="INSERT INTO th_user(Name,Usrname,Email,Password)VALUES('$name','$username','$email','$password')";
